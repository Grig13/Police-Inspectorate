...
var connectionString = builder.Configuration.GetConnectionString("PoliceInspectorateContextConnection") ?? throw new InvalidOperationException("Connection string 'PoliceInspectorateDb' not found.");
